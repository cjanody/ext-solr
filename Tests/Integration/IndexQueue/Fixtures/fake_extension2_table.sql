...
DROP TABLE IF EXISTS tx_fakeextension_domain_model_nested_related_mm;

CREATE TABLE tx_fakeextension_domain_model_nested_related_mm (
   uid_local int(11) unsigned DEFAULT '0' NOT NULL,
   uid_foreign int(11) unsigned DEFAULT '0' NOT NULL,
   tablenames varchar(90) DEFAULT '' NOT NULL,
   sorting int(11) unsigned DEFAULT '0' NOT NULL,
...
DROP TABLE IF EXISTS tx_fakeextension_domain_model_nestedmmrelated;

CREATE TABLE tx_fakeextension_domain_model_nestedmmrelated (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
	tstamp int(11) DEFAULT '0' NOT NULL,
	crdate int(11) DEFAULT '0' NOT NULL,
